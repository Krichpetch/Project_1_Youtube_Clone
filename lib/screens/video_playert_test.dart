...
class MusicVideoPlayerPageTest extends StatefulWidget {
  ...
  @override
  _MusicVideoPlayerPageTestState createState() => _MusicVideoPlayerPageTestState();
}

class _MusicVideoPlayerPageTestState extends State<MusicVideoPlayerPageTest> {
  ...
  void _initializeVideoPlayer() {
    _videoPlayerController =
        VideoPlayerController.asset(_getVideoPath("02_Ice_Saranyu-Khon_Man_Rak"))
          ..addListener(() {
            setState(() {
              _currentSliderValue =
        ...
        Stack(
          children: [
            showVideo
                ...
                : const CoverImage(imageName:"02_Ice_Saranyu-Khon_Man_Rak"),
          ],
        ),
